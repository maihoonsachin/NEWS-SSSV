...
const  NewsItem = (props) => {
        let {title, description,imageUrl,newsId} = props;
        return(
            <div className="my-3">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text"><small className="text-body-secondary">{`By ${(props.author)? props.author : 'Unknown'} on :${new Date(props.publishedAt).toGMTString()}`}</small></p>
